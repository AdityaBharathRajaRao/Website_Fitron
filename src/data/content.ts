...
export const faqs = [
  {
    ...
    answer: "All our components are manufactured to ASTM, ASME, and ISO standards. We provide full material certifications, dimensional reports, and test documentation with every order.",
  },
  {
    question: "Can you handle custom OEM requirements?",
    answer: "Yes, we specialize in custom manufacturing from prototypes to production runs. Our engineering team works closely with clients to develop components that meet exact specifications.",
  },
  {
    question: "What is your typical lead time?",
    answer: "Standard catalog items: 2-4 weeks. Custom components: 6-10 weeks depending on complexity. Rush orders available with expedited processing.",
  },
  {
    question: "Do you export internationally?",
    answer: "Yes, we export to clients worldwide with full export documentation, compliance certificates, and international shipping support.",
  },
  {
    question: "What quality certifications do you hold?",
    answer: "We maintain ISO 9001:2015 certification and follow stringent quality protocols including CMM inspection, material testing, and process validation.",
  },
  {
    question: "Can I visit your manufacturing facility?",
    answer: "Absolutely. We welcome client visits to our Bangalore facility. Please contact us to schedule a tour and meet our engineering team.",
  },
];
